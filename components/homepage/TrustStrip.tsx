...
export default function TrustStrip() {
  ...
  return (
    <section className="bg-[var(--bg-secondary)] border-b border-[var(--border)] py-6 sm:py-8">
          ...
          {TRUST_KEYS.map((key, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-[var(--text-primary)] text-xs sm:text-sm tracking-[0.1em] uppercase font-medium">
                  {t(key)}
                </p>
              </div>
            );
