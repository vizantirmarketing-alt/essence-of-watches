              ...
              {items.map((item, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group bg-[var(--bg-secondary)] border border-[var(--border)] overflow-hidden"
                  >
                    <div className="relative aspect-square bg-[var(--bg-primary)] overflow-hidden">
                      ...
                      <button
                        ...
                        className="absolute top-3 right-3 w-10 h-10 rounded-full bg-white border border-[var(--border)] flex items-center justify-center text-red-500 opacity-100 hover:bg-red-50 hover:border-red-300 transition-all shadow-sm"
                      ...
                      >
                        <span className="bg-black text-white px-6 py-3 text-xs tracking-[0.15em] uppercase opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0 shadow-lg">
                          View Details
                        </span>
                      </Link>
                    </div>
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 pt-4 border-t border-[var(--border)] flex gap-3">
                        <button
                          ...
                          className="flex-1 bg-[var(--text-primary)] text-[var(--bg-primary)] py-2.5 text-xs tracking-[0.1em] uppercase hover:opacity-90 transition"
                        >
                          Add to Cart
                        </button>
                        <button
                          type="button"
                          onClick={() => removeItem(item.id)}
                          className="px-3 py-2.5 border border-[var(--border)] text-[var(--text-muted)] hover:text-red-500 hover:border-red-500 transition"
                          aria-label="Remove"
                        >
                          <svg
                            width="16"
