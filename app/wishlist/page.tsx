      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-[var(--text-secondary)] mt-4">
            {wishlistItems.length} {wishlistItems.length === 1 ? 'timepiece' : 'timepieces'} saved
          </p>
        </motion.div>
                ...
                >
                  ...
                  <div className="relative aspect-square bg-[var(--bg-primary)] dark:bg-[#0a0a0a] overflow-hidden">
                    ...
                    {!item.inStock && (
                      <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                        <span className="text-white text-xs tracking-[0.2em] uppercase bg-black/50 px-4 py-2">
                          Sold
                        </span>
                      </div>
                    )}
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-xs text-[var(--text-muted)] mb-3">
                      Ref. {item.ref} • {item.condition} • {item.year}
                    </p>
                    ...
                    <div className="mt-4 pt-4 border-t border-[var(--border)] dark:border-[#262626] flex gap-3">
                      {item.inStock ? (
                        <>
                          <button className="flex-1 bg-[var(--text-primary)] dark:bg-white dark:text-black text-[var(--bg-primary)] py-2.5 text-xs tracking-[0.1em] uppercase hover:opacity-90 transition">
                            Add to Cart
                          </button>
                          <button
                        ...
                        <>
                          <Link
                            href="/source"
                            className="flex-1 border border-[var(--border)] dark:border-[#444] text-[var(--text-primary)] py-2.5 text-xs tracking-[0.1em] uppercase hover:bg-[var(--bg-secondary)] dark:hover:bg-[#1a1a1a] transition text-center"
                          >
                            Source Similar
                          </Link>
                          <button
